...
from base.src.utils import gen_rand_str
...
class Wrapper:
    def __init__(self, cfg: config.Config):
        ...
        os.environ["LANGCHAIN_PROJECT"] = "TAIA base - Experiments v1"
    ...
    def clone_git_repo(nf_vendor: str, upstream_repo: str) -> (bool, str):
        path = f"/home/pmq/workshop/python-programming/taia/base/cloned-repos/{nf_vendor}"
    ...
    def hello_msg(self):
        msg = self.llm.invoke(
            """
            Please pretend that you are Telco AI Assistant (TAIA base). You are able to deploy 5G Network Functions.
