...
from base.src.tools import tools, wrapper
from base.src.prompts import taia_prompt
...
if __name__ == "__main__":
    ...
    print(f"[TAIA base] I'm your Telco AI Assistant. What can I do for you?")
    for _ in range(5):
        query = input("[Human] > ")
